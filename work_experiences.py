...
work_experiences.append(
    WorkExperience(
        ...
        end_date="Present",
        bullets=[
            "Led design and testing of production software for controlling Phased Array devices using Python and C",
            "Developed production radar software for controls and processing in embedded and desktop Linux environments",
            "Wrote radar data signal processing pipeline in C and Python and used Docker (Podman) to deploy on Red Hat Linux",
